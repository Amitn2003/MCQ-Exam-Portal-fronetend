...
// import { getRandomQuestions, getQuestionsByCategory } from '../api/questionApi'; // Assuming you have an API function to fetch questions
// import { addExamResult } from '../api/examResultApi'; // API function to save exam results
// import { useAuth } from '../hooks/useAuth'; // Custom hook for authentication
// import { useNavigate } from 'react-router-dom';

// const GetQuestions = ({ totalQs = 10, selectedCategory = null }) => {
//     const [questions, setQuestions] = useState([]);
//     const [currentQuestionIndex, setCurrentQuestionIndex] = useState(0);
//     const [userAnswers, setUserAnswers] = useState(new Array(totalQs).fill(null));
...
//                 let data = [];
//                 if (selectedCategory) {
//                     data = await getQuestionsByCategory(selectedCategory, totalQs, user.token);
//                 } else {
//                     data = await getRandomQuestions(totalQs, user.token);
//                 }
//                 setQuestions(data);
...
//         fetchQuestions();
//     }, [totalQs, selectedCategory, user.token]);
...
// import React, { useEffect, useState } from 'react';
// // import { getQuestionsByCategory, addExamResult } from '../api/examApi'; // Assuming you import the getQuestionsByCategory function
// import { getQuestionsByCategory,  getRandomQuestions } from '../api/questionApi'; // Assuming you import the getQuestionsByCategory function
...
//     useEffect(() => {
//         // Fetch questions when selectedCategory changes
//         const fetchQuestions = async () => {
//             if (selectedCategory) {
//                 try {
//                     console.log(selectedCategory)
//                     const data = await getQuestionsByCategory(selectedCategory, user.token);
//                     setQuestions(data);
//                     setUserAnswers(new Array(data.length).fill(null));
//                 } catch (error) {

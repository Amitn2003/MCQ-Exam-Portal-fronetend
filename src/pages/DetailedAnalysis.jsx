...
const DetailedAnalysis = () => {
    ...
    //     <p className="text-gray-600 dark:text-gray-400 mb-2">Exam taken on {new Date(result.createdAt).toLocaleDateString()}</p>
    //     <p className="text-gray-600 dark:text-gray-400 mb-2">Score: {result.score}/{result.totalQuestions}</p>
    //     <p className="text-gray-600 dark:text-gray-400 mb-4">Accuracy: {result.accuracy.toFixed(2)}%</p>
    //     <ul>
    //         {result.questions.map((questionResult, index) => (
    //             <li key={index} className="mb-4">
    //                 <h4 className="font-semibold mb-2">{questionResult.question.question}</h4>
    //                 <p className="text-gray-600 dark:text-gray-400 mb-1">Your Answer: {questionResult.question.options[questionResult.selectedAnswer]}</p>
    //                 <p className="text-gray-600 dark:text-gray-400 mb-1">Correct Answer: {questionResult.question.options[questionResult.question.correctAnswer]}</p>
    //                 {questionResult.question.explanation && (
    //                     <p className="text-gray-600 dark:text-gray-400 mb-1">Explanation: {questionResult.question.explanation}</p>
    //                 )}
    //             </li>
    //         ))}
    //     </ul>

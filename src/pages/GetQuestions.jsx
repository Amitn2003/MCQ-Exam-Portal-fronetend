        ...
        <div className="bg-gray-100 dark:bg-gray-800 min-h-screen py-8 px-4 sm:px-6 lg:px-8">
            {!examStarted ? (
                ...
                <div className="max-w-lg mx-auto bg-white text-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
                    <h2 className="text-2xl font-bold mb-4 text-gray-900">Exam Questions</h2>
                    {questions.length === 0 ? (
                            ...
                            {!showReport ? (
                                <div>
                                    <div className="mb-4">
                                        ...
                                        <div className="mb-4">
                                            <h3 className="text-lg font-medium mb-2 text-gray-800">Time Left: {formatTime(timeLeft)}</h3>
                                        </div>
                                ...
                                <div>
                                    <h2 className="text-2xl font-bold mb-4 text-gray-900">Exam Report</h2>
                                    <ul>
                                        {questions.map((question, index) => (
                                            <li key={index} className="mb-4 text-gray-900">
                                                ...
                                                {question.explanation && (
                                                    <p className="text-gray-500"><span className='font-bold'>Explanation: </span>{question.explanation}</p>
                                                )}
                                            </li>
                                        ))}
                                    </ul>
                                    <div className="mt-4">
                                        <p className="text-lg font-medium text-gray-800">Score: {score}/{questions.length}</p>
                                        <p className="text-lg font-medium text-gray-800">Accuracy: {accuracy.toFixed(2)}%</p>
                                    </div>
                                    <div className="mt-4">
                                        <button
                                            className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md mr-2"
